...
ventana=Frame(raiz, bg="violet", height=400, width=20)
ventana.pack()

##################################################################

botonverde=Button(ventana, text="Verde", fg="green", bg="violet", command=lambda: color("green"))
botonverde.grid(row=1, column=0)

botonamarillo=Button(ventana, text="Amarillo", fg="yellow", bg="violet", command=lambda: color("yellow"))
botonamarillo.grid(row=1, column=1)

botonrojo=Button(ventana, text="Rojo", fg="red", bg="violet", command=lambda: color("red"))
...
comentarioscroll=Scrollbar(ventana, command=entrycomentarios.yview)
entrycomentarios.config(yscrollcommand=comentarioscroll.set)
